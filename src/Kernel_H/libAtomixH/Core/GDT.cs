...
namespace libAtomixH.Core
{
    ...
    {
        private static uint _gdtTable = 0x25082C; //0x200020 + 2048 (IDT Content) + 6 (IDT Pointer) + <Some space unused>
        private static uint _gdtEntries = 0x25082C + 6;
        ...
        private static void FlushGDT ()
        {
            ...
            asm.AssemblerCode.Add (new Literal ("jmp 8:Far_Jumper.End"));
            asm.AssemblerCode.Add (new Label ("Far_Jumper.End"));
        }
    }
}
