...
#line hidden
        ...
        public virtual string TransformText()
        {
            ...
            #line 14 "D:\Atomix\Src\Compiler\log2html.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(ExecuteTime));
 ...
 for(int i=0; i < Ascript.Count ; i++)
		   { 
            ...
            #line 21 "D:\Atomix\Src\Compiler\log2html.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(Ascript[i].ToString()));
            ...
            #line 21 "D:\Atomix\Src\Compiler\log2html.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(Amessage[i]));
 ...
 for(int i=0; i < Adetail.Count ; i++)
		   { 
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(Adetail[i].ToString()));
