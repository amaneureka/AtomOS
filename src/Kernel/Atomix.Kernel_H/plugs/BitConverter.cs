...
namespace Atomix.Kernel_H.plugs
{
    internal static class BitConverter
    {
        ...
        internal static UInt32 ToUInt32(byte[] xData, int pos)
        {
        ...
        internal static Int32 ToInt32(byte[] xData, int pos)
        {
